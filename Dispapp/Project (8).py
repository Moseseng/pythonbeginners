...
class tickets:
    def __init__(self,root):
        ...
        #manageb.place(x=1100,y=30,width=250,height=630)
        ...
        Combo = ttk.Combobox(self.root, values = vlist)
        Combo.set("Pick an Option")
        Combo.place(x=170,y=60,width=160)
